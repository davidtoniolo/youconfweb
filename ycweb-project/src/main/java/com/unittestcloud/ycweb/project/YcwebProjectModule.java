...
/**
 * This class manages the lifecycle of the ycweb-project module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class YcwebProjectModule extends BlossomModuleSupport implements ModuleLifecycle {
