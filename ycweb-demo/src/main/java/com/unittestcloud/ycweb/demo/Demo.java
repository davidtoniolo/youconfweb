package com.unittestcloud.ycweb.demo;
...
/**
 * This class manages the lifecycle of the ycweb-demo module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class Demo extends BlossomModuleSupport implements ModuleLifecycle {
