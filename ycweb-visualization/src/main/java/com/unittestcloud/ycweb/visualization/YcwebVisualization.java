...
/**
 * This class manages the lifecycle of the ycweb-visualization module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class YcwebVisualization extends BlossomModuleSupport implements ModuleLifecycle {
